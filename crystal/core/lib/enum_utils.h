...
#define FUNC_SIG
    ...
    namespace impl {
        ...
        consteval std::string_view enum_to_string_impl() noexcept {
        ...
        consteval std::string_view enum_to_string_helper(Enum value, std::integer_sequence<int, I...>) {
        ...
        [[nodiscard]] consteval std::optional<Enum> enum_from_string_impl(std::string_view name, std::integer_sequence<int, I...>) noexcept {
    ...
    consteval auto enum_to_string(Enum enumValue) noexcept -> std::enable_if_t<std::is_enum_v<std::decay_t<Enum>>, std::string_view> {
    ...
    consteval auto enum_to_string() noexcept -> std::enable_if_t<std::is_enum_v<std::decay_t<decltype(EnumValue)>>, std::string_view> {
        return impl::enum_to_string_impl<decltype(EnumValue), EnumValue>();
    }

    template<class Enum, class U = std::underlying_type_t<std::decay_t<Enum>>>
    consteval auto string_to_enum(std::string_view name) noexcept
